      ...
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center gap-6">
        ...
        <div className="ml-auto w-40 sm:w-64">
          <div className="relative">
            <input
              className="w-full rounded-md bg-neutral-950 border border-neutral-800 px-3 py-2 pl-8 text-sm text-white/90 placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#D32F2F]"
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          >
            ...
            >
              ...
              <path d="M1 1h4l2.8 13.4a1 1 0 0 0 1 .8h9.9a1 1 0 0 0 1-.8L22 6H6" />
            </svg>
            Carrito
          </Link>
