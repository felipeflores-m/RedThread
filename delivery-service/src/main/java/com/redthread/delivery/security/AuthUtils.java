...
public class AuthUtils {
    ...
    public Long getCurrentUserId(@AuthenticationPrincipal Jwt jwt) {
        ...
        try { return sub != null ? Long.parseLong(sub) : null; }
    ...
    public boolean hasAdmin(Jwt jwt) {
        ...
        if (roles instanceof Iterable<?> it) {
            for (Object r : it) if (String.valueOf(r).equalsIgnoreCase("ADMIN")) return true;
        }
        // fallback scopes/authorities si vienen
        return false;
    }
}
